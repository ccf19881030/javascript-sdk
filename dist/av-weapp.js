...
module.exports = function (AV) {
  ...
  /** @lends AV.User.prototype */{
    ...
    updatePassword: function updatePassword(oldPassword, newPassword, options) {
      ...
      return request.then(function (resp) {
        _this10._finishFetch(_this10.parse(resp));
        return _this10._handleSaveResult(true).then(function () {
          return resp;
        });
      });
    },
    ...
    isAuthenticated: function isAuthenticated() {
      ...
      return _promise2.default.resolve().then(function () {
        return !!_this11._sessionToken && AV.User._fetchUserBySessionToken(_this11._sessionToken).then(function () {
          return true;
        }, function (error) {
          if (error.code === 211) {
            return false;
  ...
  /** @lends AV.User */{
    ...
    loginWithWeapp: function loginWithWeapp(options) {
      ...
      return getMiniappLoginCode().then(function (code) {
        return _this13.loginWithAuthData(getMiniappAuthData()(code, options), PLATFORM_WEAPP, options);
      });
    },
    ...
    loginWithWeappWithUnionId: function loginWithWeappWithUnionId(unionId, unionLoginOptions) {
      ...
      return getMiniappLoginCode().then(function (code) {
        return _this14.loginWithAuthData(mergeUnionDataIntoAuthData()({ code: code }, unionId, unionLoginOptions), PLATFORM_WEAPP, unionLoginOptions);
      });
    },
    ...
    loginWithQQApp: function loginWithQQApp(options) {
      ...
      return getMiniappLoginCode().then(function (code) {
        return _this15.loginWithAuthData(getMiniappAuthData('qq')(code, options), PLATFORM_QQAPP, options);
      });
    },
    ...
    loginWithQQAppWithUnionId: function loginWithQQAppWithUnionId(unionId, unionLoginOptions) {
      ...
      return getMiniappLoginCode().then(function (code) {
        return _this16.loginWithAuthData(mergeUnionDataIntoAuthData('qq')({ code: code }, unionId, unionLoginOptions), PLATFORM_QQAPP, unionLoginOptions);
      });
    },
